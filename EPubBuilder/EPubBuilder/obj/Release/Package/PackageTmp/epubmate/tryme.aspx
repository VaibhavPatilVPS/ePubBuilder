<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tryme.aspx.cs" Inherits="iCE_Webapp_Bootstrap.epubmate.tryme" %>
                        ...
                        <div class="form-group wow fadeInDown" style="text-align: center; display: inline-block;">
                            <table style="line-height: 40px;">
                                ...
                                <tr style="text-align: right;">
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="form-control setwidth300" required ID="Lastname" runat="server" placeholder="Last Name" />
                                    </td>
                                    <td></td>
                                </tr>
                                <tr style="text-align: right;">
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="form-control setwidth300" required ID="Email" runat="server" placeholder="E-Mail Address" />
                                    </td>
                                    <td style="text-align: left;">
                                        <div runat="server" id="emaildiv">
                                            <asp:RegularExpressionValidator ID="regexEmailValid" runat="server" Style="color: red; font-size: 12px; text-align: left;" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="Email" ErrorMessage="Invalid Email Format"></asp:RegularExpressionValidator>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="text-align: right;">
...
<%--                                <tr style="text-align: right;">
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td style="padding-top: 10px;">
                                        <asp:Button CssClass="btn btn-primary" ID="btnSubmit" Text="Register and Try Me" runat="server" OnClick="btnSubmit_Click" />
                                    </td>
                                    <td></td>
                                </tr>
                                <%--<tr style="text-align: right;">
