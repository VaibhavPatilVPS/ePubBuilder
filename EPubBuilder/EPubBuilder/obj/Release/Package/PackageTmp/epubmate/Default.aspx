<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="iCE_Webapp_Bootstrap.epubmate.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ePubMate Features</title>
    <meta charset="utf-8" />
    <meta name="description" content="ePubMate Features" />
            ...
            <div class="container">
                ...
                <div class="navbar-collapse navbar-right">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="Default.aspx">ePubMate</a></li>
        ...
        <form runat="server" name="form1">
            <div class="container-fluid txrow_vc1">
                <div class="section-header">
                    ...
                    <h3 class="text-center wow fadeInDown">Automated eBook conversion platform.</h3>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <h2>Fixed Layout eBooks</h2>
                            <p>Give the same look of printed book when read on digital devices; Fixed Layout is good when it’s important that the images and text appear in a specific and consistent way Some good candidates are:</p>
                            <ol type="1">
                                <li>Children books</li>
                                <li>Cook books</li>
                                <li>Boutique books</li>
                                <li>Complex design books</li>
                                <li>Many more …</li>
                            </ol>
                            <a href="tryme.aspx" class="btn btn-primary">Try me</a>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <h2>Reflowable eBooks</h2>
                            <p>Electronic book that can be easily read on digital devices irrespective of their screen size and have flexibility to increase type size, change font, give option to change screen color etc.</p>
                            <p>eBooks are an easy way to reach to the new age audience quickly, efficiently and across various digital channels like:</p>
                            <ol type="1">
                                <li>Apple iBooks</li>
                                <li>Google Play Books</li>
                                <li>Amazon Kindle store</li>
                                <li>Many more …</li>
                            </ol>
