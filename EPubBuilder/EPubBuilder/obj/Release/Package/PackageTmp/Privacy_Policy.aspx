<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Privacy_Policy.aspx.cs" Inherits="iCE_Webapp_Bootstrap.Privacy_Policy" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>iMrave :: Privacy Policy</title>
    <meta charset="utf-8" />
    ...
    <section id="get-in-touch">
        <div class="container-fluid txrow_vc1">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Privacy Policy</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12" style="text-align: center;">
                    ...
                    <form runat="server" name="form1">
                        <p class="text-center wow fadeInDown">Privacy Policy text comes here !!!</p>
