<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="project_config.aspx.cs" Inherits="iCE_Webapp_Bootstrap.project_config" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PubMate Project based Configuration</title>
    <meta charset="utf-8" />
    <meta name="description" content="PubMate Project based Configuration" />
            ...
            <div class="container-fluid txrow_vc1">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-9">
                        <h3>Project Based Configuration</h3>
                        <div class="form-group pull-left">
                            <asp:Label ID="prolable" runat="server" CssClass="h4">Select Project: </asp:Label>
                            <asp:DropDownList runat="server" CssClass="form-control pull-left" ID="selProjectCombo" AutoPostBack="true" OnSelectedIndexChanged="OnSelectedIndexChanged"></asp:DropDownList>
                        </div>
                        <br />
                        <br />
                        <br />
                        <br />
                        <div class="form-group">
                            <asp:TreeView ID="TreeView1" runat="server" OnTreeNodeCheckChanged="TreeView1_TreeNodeCheckChanged" ShowCheckBoxes="All" OnTreeNodePopulate="TreeView1_TreeNodePopulate"></asp:TreeView>
                        </div>
                        <div class="form-group">
                            <asp:Button ID="updateProjectSettingsBtn" CssClass="btn btn-primary pull-left" OnClick="updateProjectSettingsBtn_Click" runat="server" Text="Update Project based Settings" />
                        </div>
                    </div>
                </div>
            </div>
