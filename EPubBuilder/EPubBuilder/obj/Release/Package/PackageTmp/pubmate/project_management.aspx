<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="project_management.aspx.cs" Inherits="iCE_Webapp_Bootstrap.project_management" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PubMate Project Management</title>
    <meta charset="utf-8" />
    <meta name="description" content="PubMate Project Management" />
            ...
            <div class="container-fluid txrow_vc">
                <div class="row ">
                    <div class="features">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 fadeInUp img-responsive" data-wow-duration="300ms" data-wow-delay="100ms">
                            <div class="media service-box" style="width: 100%">
                                <div class="media-body col-xs-12 wow fadeInUp table-responsive" data-wow-duration="300ms" data-wow-delay="0ms">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" ID="proname" runat="server" placeholder="Project Name" />
                                    </div>
                                    <asp:Button CssClass="btn btn-primary updatebtncss" ID="ButtonAddProject" Text="Add Project" runat="server" OnClick="ButtonAddProject_Click" />
                                </div>
                            </div>
                        </div>

                        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp img-responsive" data-wow-duration="300ms" data-wow-delay="100ms">
                            <div class="media service-box" style="width: 100%">
                                <div class="media-body col-xs-12 wow fadeInUp table-responsive" data-wow-duration="300ms" data-wow-delay="0ms">
                                    <%------GRID view Start--------%>
                                    <h4>User Management</h4>
                                    <div id="mainoperation" runat="server" style="width: 100%">
                                        <asp:GridView CssClass="col-md-8 col-sm-8 col-sm-12 report" ID="GridView1" runat="server" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Project Name">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="projectname" runat="server" Text='<%# Eval("name") %>'></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Active Project?">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="cb1" runat="server" Checked='<%# Eval("isactive") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
