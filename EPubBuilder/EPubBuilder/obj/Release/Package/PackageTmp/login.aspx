<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="iCE_Webapp_Bootstrap.login" %>
        ...
        <div class="container-fluid txrow_vc1">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="text-align: center;">
                    ...
                    <div class="form-group">
                        <a href="epubmate/tryme.aspx" class="btn btn-primary">SIGN UP</a>
